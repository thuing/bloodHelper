...
class doctorViewController: UIViewController {
    ...
    func setView() {
        ...
        patientChangedButton.addTarget(self, action: #selector(buttonClick(_:)), for: .touchUpInside)
        ...
        patientPersonalButton.addTarget(self, action: #selector(buttonClick(_:)), for: .touchUpInside)
        ...
        patientAfterButton.addTarget(self, action: #selector(buttonClick(_:)), for: .touchUpInside)
